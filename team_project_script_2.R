...
ggsave("refugees_country_africa.png")
...
ggplot(data = refugees_by_country_Americas) +
...
ggsave("refugees_country_americas.png")
...
ggsave("Colombia_refugees_year.png")
